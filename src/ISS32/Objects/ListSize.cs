...
namespace IIS.ISS32
{
    ...
    public class ListSize : ICSSoft.STORMNET.DataObject
    {
        ...
        [NotNull()]
        public virtual IIS.ISS32.Size Size
        {
            get
            {
                ...
                IIS.ISS32.Size result = this.fSize;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ListSizeE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ListSizeE", typeof(IIS.ISS32.ListSize));
                }
            }
        }
    }
    ...
    public class DetailArrayOfListSize : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.ISS32.DetailArrayOfListSize members)

        // *** End programmer edit section *** (IIS.ISS32.DetailArrayOfListSize members)
        ...
        /// </summary>
        public DetailArrayOfListSize(IIS.ISS32.Support fSupport) : 
                base(typeof(ListSize), ((ICSSoft.STORMNET.DataObject)(fSupport)))
        {
        }
        
        public IIS.ISS32.ListSize this[int index]
        {
            get
            {
                return ((IIS.ISS32.ListSize)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.ISS32.ListSize dataobject)
        {
