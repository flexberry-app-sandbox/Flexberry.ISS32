...
namespace IIS.ISS32
{
    ...
    public class Support : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.ISS32.Form fForm;
        
        private IIS.ISS32.DetailArrayOfListInv fListInv;
        
        private IIS.ISS32.DetailArrayOfListSize fListSize;
        ...
        [NotNull()]
        public virtual IIS.ISS32.Form Form
        {
            get
            {
                ...
                IIS.ISS32.Form result = this.fForm;
        ...
        public virtual IIS.ISS32.DetailArrayOfListInv ListInv
        {
            get
            {
                ...
                {
                    this.fListInv = new IIS.ISS32.DetailArrayOfListInv(this);
                }
                IIS.ISS32.DetailArrayOfListInv result = this.fListInv;
        ...
        public virtual IIS.ISS32.DetailArrayOfListSize ListSize
        {
            get
            {
                ...
                {
                    this.fListSize = new IIS.ISS32.DetailArrayOfListSize(this);
                }
                IIS.ISS32.DetailArrayOfListSize result = this.fListSize;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View SupportE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("SupportE", typeof(IIS.ISS32.Support));
                }
            }
            ...
            public static ICSSoft.STORMNET.View SupportL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("SupportL", typeof(IIS.ISS32.Support));
                }
            }
        }
    }
